...
-- Get order with total (used in reports)
CREATE PROCEDURE sp_GetOrderReport (@OrderID INT)
AS
BEGIN
    SELECT
        o.OrderID,
...
INSERT INTO Item (ItemName, Size, UnitPrice, Stock) VALUES
('Laptop Dell XPS 13',  '13"', 25000000, 50),
('Laptop HP Envy 15',   '15"', 22000000, 40),
('Laptop Asus ZenBook', '14"', 20000000, 60),
('Mouse Logitech M705', 'N/A',   350000, 200),
('Keyboard Mechanical', 'Full',  900000, 150),
('Monitor Samsung 24"', '24"',  5500000, 80),
('Monitor LG 27"',      '27"',  7200000, 60),
('USB-C Hub 7-in-1',    'N/A',   450000, 300),
('Webcam Logitech C920','N/A',  1800000, 90),
('Headset Sony WH-1000','N/A',  4200000, 70),
('SSD Samsung 500GB',   '500G', 1750000, 120),
('RAM Kingston 16GB',   '16GB', 1200000, 180),
('Laptop Bag 15"',      '15"',   320000, 250),
('Desk Lamp LED',       'N/A',   280000, 200),
('Smartphone Stand',    'N/A',   150000, 400),
('Cable HDMI 2m',       '2m',     85000, 500),
('Printer HP LaserJet', 'A4',   6500000, 30),
('Ink Cartridge Black', 'N/A',   350000, 300),
('A4 Paper 70gsm',      'A4',     65000, 600),
('Power Bank 20000mAh', 'N/A',   850000, 110);
